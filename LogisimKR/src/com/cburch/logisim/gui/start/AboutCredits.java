...
class AboutCredits extends JComponent {
	...
	public AboutCredits() {
		...
		lines.add(new CreditsLine(1, "logisimkr.ga/logisim/"));
		...
		lines.add(new CreditsLine(0, Strings.get("creditsRemaster")));
		lines.add(new CreditsLine(1, "Yottabyte090(Sangwon Ryu)"));
		lines.add(new CreditsLine(0, Strings.get("creditsWebsiteHelp")));
		lines.add(new CreditsLine(1, "SHRIMP(Minjun Kim)"));
		lines.add(new CreditsLine(0, Strings.get("creditsLogoHelp")));
		lines.add(new CreditsLine(1, "OmegaThree(Jaemin Park)"));
		lines.add(new CreditsLine(0, Strings.get("creditsRoleKorean")));
		lines.add(new CreditsLine(1, "cafe.naver.com/powdertoy/"));
