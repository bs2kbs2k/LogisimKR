...
public class About {
	...
	private static class MyPanel extends JPanel implements AncestorListener {
		...
		private final Font headerFont = new Font("Serif", Font.BOLD, 50);
		private final Font versionFont = new Font("Serif", Font.PLAIN | Font.ITALIC, 30);
		private final Font copyrightFont = new Font("Serif", Font.ITALIC, 20);
